...
export const gallery = [
  { src: "/gallery/decks/IMG_5305.jpg", alt: "Gray composite deck with cable railing and lattice skirting", label: "Deck", cat: "decks" as const },
  { src: "/gallery/decks/IMG_5455.jpg", alt: "Two-story cedar deck with glass railing", label: "Deck", cat: "decks" as const },
  { src: "/gallery/decks/IMG_5460.jpg", alt: "Wrap-around deck with black cable railing", label: "Deck", cat: "decks" as const },
  { src: "/gallery/decks/IMG_5465.jpg", alt: "Deck corner with cable railing", label: "Deck", cat: "decks" as const },
